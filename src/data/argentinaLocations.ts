...
export const GBA_LOCALITIES = [
  ...
  "El Talar", "Gonnet", "González Catán", "Grand Bourg",
  ...
  "Victoria", "Villa Adelina", "Villa Martelli",
  ...
  "Don Torcuato", "Los Troncos", "Nordelta", "Ricardo Rojas",
  "Rincón de Milberg", "San Isidro Labrador",
  "Ciudadela", "El Libertador", "Loma Hermosa", "José Ingenieros",
  "San Andrés", "Santos Lugares", "Villa Lynch",
  "Villa Maipú", "Billinghurst",
  "Carapachay", "Florida Este", "Florida Oeste",
  "Aldo Bonzi", "Ciudad Evita", "Gregorio de Laferrere",
  "Isidro Casanova", "La Tablada", "Lomas del Mirador", "Rafael Castillo",
  "Tapiales", "Virrey del Pino",
  "20 de Junio", "9 de Abril", "Canning", "El Jagüel", "Luis Guillón",
  "Monte Grande", "Tristán Suárez",
  "Alejandro Korn", "Domselaar",
  "Glew", "Longchamps", "José Mármol", "Ministro Rivadavia",
  "Abasto", "Arturo Seguí", "El Peligro", "Etcheverry",
  "Gorina", "Hernández", "Lisandro Olmos", "Los Hornos",
  "Manuel B. Gonnet", "Melchor Romero", "Ringuelet", "San Carlos",
  "Tolosa", "Villa Elisa", "Villa Elvira",
  "Ezpeleta", "San Francisco Solano",
  "Solano", "Bernal Oeste",
  "Área de Promoción El Triángulo", "Bosques", "Pereyra",
  "Ranelagh", "Sourigues", "Villa España", "Plátanos", "Gutiérrez",
  "Ingeniero Allan", "La Capilla", "Villa Brown",
  "Gerli", "Lanús Este", "Lanús Oeste", "Monte Chingolo",
  "Valentín Alsina", "Crucecita",
  "Villa Fiorito", "Villa Centenario", "Villa Industriales",
  "Avellaneda Centro", "Piñeyro",
  "Berazategui Centro", "El Pato", "Juan María Gutiérrez",
  "Ciudad Jardín Lomas del Palomar", "Martín Coronado",
  "Sáenz Peña", "Villa Raffo",
  "Hurlingham Centro", "Villa Santos Tesei",
  "Muñiz", "San Miguel Centro",
  "Ingeniero Pablo Nogués", "Pablo Nogués",
  "La Lonja", "Manzanares",
  "Presidente Derqui", "Villa Astolfi", "Villa del Pilar",
  "Francisco Álvarez", "La Reja", "Mariano Acosta",
  "Paso del Rey", "Pontevedra", "San Antonio de Padua", "Libertad",
  "Cuartel V", "La Perlita", "Moreno Centro", "Trujui",
  "Morón Centro", "Villa Sarmiento",
  "Ituzaingó Centro", "Villa Udaondo",
  "Ingeniero Maschwitz", "Loma Verde",
  "Campana Centro", "Los Cardales",
  "Zárate Centro", "Lima",
  "Luján Centro", "Olivera", "Open Door", "Torres",
  "Capilla del Señor", "Pavón",
  "General Rodríguez Centro", "La Bota",
  "Marcos Paz Centro",
  "Cañuelas Centro", "Máximo Paz", "Vicente Casares",
  "Guernica",
  "Ezeiza Centro", "La Unión",
...
export const MAJOR_CITIES: Record<string, string[]> = {
  ...
  "Corrientes": [
    ...
    "San Roque", "Sauce", "Lavalle", "Santa Lucía",
