...
export const PriceSlider = ({ priceData, waitingCount = 0 }: PriceSliderProps) => {
  ...
  return (
    <section className="pt-1 pb-4 mt-6" data-test-id="price-slider">
                ...
                {priceData.map((item, index) => {
                  ...
                  return (
                    <span
                      key={index}
                      style={pos.style}
                      className={`absolute top-0 whitespace-nowrap text-sm font-medium transition-colors ${isNearSelected ? "text-primary" : "text-muted-foreground"
                        } ${pos.className}`}
                    >
                      {item.people}
                    </span>
                ...
                {priceData.map((item, index) => {
                  ...
                  return (
                    <span
                      key={index}
                      style={pos.style}
                      className={`absolute top-0 whitespace-nowrap text-xs transition-colors ${isFirstPrice
