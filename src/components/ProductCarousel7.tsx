...
import enaBarsMain from "@/assets/ena-bars-main.png";
import enaBarsFrutilla from "@/assets/ena-bars-frutilla.png";
import enaBarsBanana from "@/assets/ena-bars-banana.png";
import enaBarsChocolate from "@/assets/ena-bars-chocolate.png";
import enaBarsInfo from "@/assets/ena-bars-info.png";

const images = [
  { src: enaBarsMain, alt: "ENA Protein Bar - Coco y Dulce de Leche" },
  { src: enaBarsFrutilla, alt: "ENA Protein Bar - Frutilla" },
  { src: enaBarsBanana, alt: "ENA Protein Bar - Banana" },
  { src: enaBarsChocolate, alt: "ENA Protein Bar - Chocolate" },
  { src: enaBarsInfo, alt: "ENA Protein Bar - Información nutricional" },
];

export const ProductCarousel7 = () => {
