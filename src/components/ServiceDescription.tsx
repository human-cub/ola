          ...
          <div className="space-y-4 text-foreground">
            ...
            <div className="bg-gradient-primary/10 rounded-lg p-4 border border-primary/20">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="grid grid-cols-4 gap-8 w-full max-w-[400px] mx-auto">
                  <div className="flex flex-col items-center gap-1">
                    <a 
                      href="https://www.instagram.com/ola.unity" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="flex items-center justify-center w-11 h-11 rounded-full bg-primary/20 hover:bg-primary/30 transition-colors"
                    >
                    ...
                    <span className="text-[10px] text-muted-foreground text-center">Instagram</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-[10px] text-muted-foreground text-center">Facebook</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-[10px] text-muted-foreground text-center">WhatsApp</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-[10px] text-muted-foreground text-center">Canal</span>
                  </div>
                </div>
