            ...
            <div className="bg-gradient-primary/10 rounded-lg p-4 border border-primary/20">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex gap-6 justify-center">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <a 
                      href="https://www.facebook.com/profile.php?id=61580099573859" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="flex items-center justify-center w-10 h-10 rounded-full bg-primary/20 hover:bg-primary/30 transition-colors"
                    >
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-xs text-muted-foreground">Grupo de WhatsApp</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center">
                  <img 
                    src="/qr-code.svg"
                    alt="QR Code"
                    className="w-[160px] h-[160px] hover:opacity-90 transition-opacity rounded-lg border-2 border-primary/30 hover:border-primary/50"
                  />
