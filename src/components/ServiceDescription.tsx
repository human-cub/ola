          ...
          <div className="space-y-4 text-foreground">
            ...
            <div className="bg-gradient-primary/10 rounded-lg p-4 border border-primary/20">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex gap-2 justify-center items-end max-w-sm mx-auto">
                  <div className="flex flex-col items-center gap-1 flex-1">
                    <a 
                      href="https://www.instagram.com/ola.unity" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="flex items-center justify-center w-9 h-9 rounded-full bg-primary/20 hover:bg-primary/30 transition-colors"
                    >
                  ...
                  <div className="flex flex-col items-center gap-1 flex-1">
                    ...
                    <span className="text-xs text-muted-foreground text-center">Canal</span>
                  </div>
                </div>
