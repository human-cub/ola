...
import omega3Main from "@/assets/omega3-main.png";
import omega3Info from "@/assets/omega3-info.png";

const images = [
  { src: omega3Main, alt: "Star Nutrition Omega 3 Fish Oil" },
  { src: omega3Info, alt: "Omega 3 - Información nutricional" },
];

export const ProductCarousel9 = () => {
