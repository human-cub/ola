                    ...
                    <div key={item.id}>
                      <div className="flex gap-4 py-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Participant indicator - show count + user's quantity */}
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-xs font-medium text-primary">
                              {participantCount + item.quantity}/100
                            </span>
                            {nextThreshold && nextThreshold.people > (participantCount + item.quantity) && (
                              <span className="text-xs text-muted-foreground">
                                · Faltan {nextThreshold.people - (participantCount + item.quantity)} para {formatPrice(nextThreshold.price)}
                              </span>
                            )}
                          </div>
