...
import { ProductCarousel8 } from "@/components/ProductCarousel8";
import { ProductInfo8 } from "@/components/ProductInfo8";
import { PriceSlider } from "@/components/PriceSlider";
import { ProductDescription8 } from "@/components/ProductDescription8";
...
const Product8 = () => {
  ...
  const product = getProduct("plant-protein");
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('product-plant-protein-updates')
      .on(
        'postgres_changes',
        {
          event: 'UPDATE',
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ProcessSteps />
      <ServiceDescription />
      <RelatedProducts currentProduct="plant-protein" />
      <FloatingButton productId="plant-protein" productName={product.name} />
    </div>
  );
};
